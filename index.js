'use strict';var _nodeTelegramBotApi=require('node-telegram-bot-api');var _nodeTelegramBotApi2=_interopRequireDefault(_nodeTelegramBotApi);var _https=require('https');var _https2=_interopRequireDefault(_https);var _express=require('express');var _express2=_interopRequireDefault(_express);var _package=require('./package.json');function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};} // importing https to make requests to travis json user data
...
var port=8000;var bot=new _nodeTelegramBotApi2.default(token,{polling:true}); // initializing new bot
// keyboard options, it will appear only once whent it's required
var opts={reply_markup:{'keyboard':[['Yes'],['No']],one_time_keyboard:true}}; // Creating express app
var app=(0,_express2.default)(); // dev server
app.get('/',function(req,res){return res.json({version:_package.version});}); // main function to execute when getting message fom user
...
var httpIntervalRequest=function httpIntervalRequest(){setInterval(function(){ // creating setInterval to make http request each 7 seconds
...
// TODO: add tests
app.listen(port,function(){return console.log('Server running on http://0.0.0.0:'+port);});
